...
public class DogEnemyController {
	...
	public void moveDog(float delta) {
		for (DogEnemy dog : listDog) {
			...
			// dog.setVelocity(new Vector2(0,0));z
			// dog.setAcceleration(new Vector2(0,0));
...
//				if (dog.getBounds().overlaps(bob.getBounds())) {
//					dog.getVelocity().add(0f,0);
//				} else{
//					if(dog.isFacingLeft()){
//					dog.getVelocity().add(0.03f,0);
//					dog.setVelocity(new Vector2(0,0));
